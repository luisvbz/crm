        ...
        <aside
            ...
            <div class="py-6 px-4 space-y-1">
                ...
                <Link :href="route('leads.index')"
                    :class="['flex items-center gap-3 px-3 py-2.5 rounded-md font-medium text-sm transition', route().current('leads.*') ? 'bg-primary-500 text-white shadow-primary' : 'text-white/70 hover:bg-white/10 hover:text-white']">
                    <TrendingUp class="w-5 h-5 opacity-70" />
                    Pipeline Leads
                </Link>

                <Link :href="route('customers.index')"
                    :class="['flex items-center gap-3 px-3 py-2.5 rounded-md font-medium text-sm transition', route().current('customers.*') ? 'bg-primary-500 text-white shadow-primary' : 'text-white/70 hover:bg-white/10 hover:text-white']">
                    ...
                    <Dropdown align="right" width="48">
                        <template #trigger>
                            <button type="button"
                                ...
                                <ChevronDown class="h-4 w-4 text-primary-400 hidden md:block" />
                            </button>
                        </template>
